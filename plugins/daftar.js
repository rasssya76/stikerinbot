...
_*Terimakasih Sudah*_
_*Mendaftarkan Diri*_
_*Dalam Database*_

 *INFO USER*
_*Nama* : ${name}_
_*Nomor* : ${who.split`@`[0]}_
_*SN* : ${sn}_
_*Total Reg* : ${totalreg} Orang_
_*Status :* ☑️ Terverifikasi_

 *NOTE*
_*Silahkan Ketik .menu*_
_*Untuk Melanjutkan*_
